 ...
 * @author RESCOM-1
 */
public class Validasilogout1 extends Dialog {

    /**
     * Creates new form Validasilogout
     */
    public Validasilogout1(JFrame fram) {
        super(fram);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnya.setBounds(130, 260, 120, 40);
        ...
        btntidak.setBounds(330, 260, 120, 40);

        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/images/Validasilogout.png"))); // NOI18N
        getContentPane().add(bg);
        bg.setBounds(0, 0, 570, 330);

        setSize(new java.awt.Dimension(588, 340));
